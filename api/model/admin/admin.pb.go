...
import (
	_ "coolfun-admin/api/model/api"
	base "coolfun-admin/api/model/base"
...
type StructResp struct {
	...
	ErrCode   base.ErrCode `protobuf:"varint,1,opt,name=errCode,proto3,enum=base.ErrCode" form:"errCode" json:"errCode" query:"errCode"`
	ErrMsg    string       `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	StructStr string       `protobuf:"bytes,3,opt,name=structStr,proto3" form:"structStr" json:"structStr" query:"structStr"`
}
...
type ProtoResp struct {
	...
	ErrCode  base.ErrCode `protobuf:"varint,1,opt,name=errCode,proto3,enum=base.ErrCode" form:"errCode" json:"errCode" query:"errCode"`
	ErrMsg   string       `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	ProtoStr string       `protobuf:"bytes,3,opt,name=protoStr,proto3" form:"protoStr" json:"protoStr" query:"protoStr"`
}
...
type CaptchaInfoResp struct {
	...
	ErrCode   base.ErrCode `protobuf:"varint,1,opt,name=errCode,proto3,enum=base.ErrCode" form:"errCode" json:"errCode" query:"errCode"`
	ErrMsg    string       `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	CaptchaID string       `protobuf:"bytes,3,opt,name=captchaID,proto3" form:"captchaID" json:"captchaID" query:"captchaID"`
	ImgPath   string       `protobuf:"bytes,4,opt,name=imgPath,proto3" form:"imgPath" json:"imgPath" query:"imgPath"`
}
...
type UpdatePolicyReq struct {
	...
	RoleID uint64            `protobuf:"varint,1,opt,name=roleID,proto3" form:"roleID" json:"roleID" query:"roleID"`
	Rules  []*PolicyPartInfo `protobuf:"bytes,2,rep,name=rules,proto3" form:"rules" json:"rules" query:"rules"`
}
...
type PolicyPartInfo struct {
	...
	Method string `protobuf:"bytes,2,opt,name=method,proto3" form:"method" json:"method" query:"method"`
}
...
type CreatePolicyReq struct {
	...
	RoleID uint64          `protobuf:"varint,1,opt,name=roleID,proto3" form:"roleID" json:"roleID" query:"roleID"`
	Info   *PolicyPartInfo `protobuf:"bytes,2,opt,name=info,proto3" form:"info" json:"info" query:"info"`
}
...
type LoginReq struct {
	...
	CaptchaID string `protobuf:"bytes,3,opt,name=captchaID,proto3" form:"captchaID" json:"captchaID" query:"captchaID"`
	Captcha   string `protobuf:"bytes,4,opt,name=captcha,proto3" form:"captcha" json:"captcha" query:"captcha"`
}
...
type SimpleRole struct {
	...
	RoleName string `protobuf:"bytes,1,opt,name=roleName,proto3" form:"roleName" json:"roleName" query:"roleName"`
...
type LoginResp struct {
	...
	Code   string `protobuf:"bytes,1,opt,name=code,proto3" form:"code" json:"code" query:"code"`
	Token  string `protobuf:"bytes,2,opt,name=token,proto3" form:"token" json:"token" query:"token"`
	Expire string `protobuf:"bytes,3,opt,name=expire,proto3" form:"expire" json:"expire" query:"expire"`
}
...
type ProfileResp struct {
	...
	ErrCode  base.ErrCode `protobuf:"varint,1,opt,name=errCode,proto3,enum=base.ErrCode" form:"errCode" json:"errCode" query:"errCode"`
	ErrMsg   string       `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	Nickname string       `protobuf:"bytes,3,opt,name=nickname,proto3" form:"nickname" json:"nickname" query:"nickname"`
	Avatar   string       `protobuf:"bytes,4,opt,name=avatar,proto3" form:"avatar" json:"avatar" query:"avatar"`
	Mobile   string       `protobuf:"bytes,5,opt,name=mobile,proto3" form:"mobile" json:"mobile" query:"mobile"`
	Email    string       `protobuf:"bytes,6,opt,name=email,proto3" form:"email" json:"email" query:"email"`
}
...
type ProfileReq struct {
	...
	Nickname string `protobuf:"bytes,1,opt,name=nickname,proto3" form:"nickname" json:"nickname" query:"nickname"`
	Avatar   string `protobuf:"bytes,2,opt,name=avatar,proto3" form:"avatar" json:"avatar" query:"avatar"`
	Mobile   string `protobuf:"bytes,3,opt,name=mobile,proto3" form:"mobile" json:"mobile" query:"mobile"`
...
type ChangePasswordReq struct {
	...
	UserID      uint64 `protobuf:"varint,1,opt,name=userID,proto3" form:"userID" json:"userID" query:"userID"`
	OldPassword string `protobuf:"bytes,2,opt,name=oldPassword,proto3" form:"oldPassword" json:"oldPassword" query:"oldPassword"`
	NewPassword string `protobuf:"bytes,3,opt,name=newPassword,proto3" form:"newPassword" json:"newPassword" query:"newPassword"`
}
...
type CreateOrUpdateUserReq struct {
	...
	ID       uint64 `protobuf:"varint,1,opt,name=ID,proto3" form:"ID" json:"ID" query:"ID"`
	Avatar   string `protobuf:"bytes,2,opt,name=avatar,proto3" form:"avatar" json:"avatar" query:"avatar"`
	RoleID   uint64 `protobuf:"varint,3,opt,name=roleID,proto3" form:"roleID" json:"roleID" query:"roleID"`
	Mobile   string `protobuf:"bytes,4,opt,name=mobile,proto3" form:"mobile" json:"mobile" query:"mobile"`
	Email    string `protobuf:"bytes,5,opt,name=email,proto3" form:"email" json:"email" query:"email"`
	Status   uint64 `protobuf:"varint,6,opt,name=status,proto3" form:"status" json:"status" query:"status"`
	Username string `protobuf:"bytes,7,opt,name=username,proto3" form:"username" json:"username" query:"username"`
	Nickname string `protobuf:"bytes,8,opt,name=nickname,proto3" form:"nickname" json:"nickname" query:"nickname"`
	Password string `protobuf:"bytes,9,opt,name=password,proto3" form:"password" json:"password" query:"password"`
}
...
type UserInfoResp struct {
	...
	ErrCode   base.ErrCode `protobuf:"varint,1,opt,name=errCode,proto3,enum=base.ErrCode" form:"errCode" json:"errCode" query:"errCode"`
	ErrMsg    string       `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	ID        uint64       `protobuf:"varint,3,opt,name=ID,proto3" form:"ID" json:"ID" query:"ID"`
	Avatar    string       `protobuf:"bytes,4,opt,name=avatar,proto3" form:"avatar" json:"avatar" query:"avatar"`
	RoleID    uint64       `protobuf:"varint,5,opt,name=roleID,proto3" form:"roleID" json:"roleID" query:"roleID"`
	Mobile    string       `protobuf:"bytes,6,opt,name=mobile,proto3" form:"mobile" json:"mobile" query:"mobile"`
	Email     string       `protobuf:"bytes,7,opt,name=email,proto3" form:"email" json:"email" query:"email"`
	Status    uint64       `protobuf:"varint,8,opt,name=status,proto3" form:"status" json:"status" query:"status"`
	Username  string       `protobuf:"bytes,9,opt,name=username,proto3" form:"username" json:"username" query:"username"`
	Nickname  string       `protobuf:"bytes,10,opt,name=nickname,proto3" form:"nickname" json:"nickname" query:"nickname"`
	RoleName  string       `protobuf:"bytes,11,opt,name=roleName,proto3" form:"roleName" json:"roleName" query:"roleName"`
	CreatedAt string       `protobuf:"bytes,12,opt,name=createdAt,proto3" form:"createdAt" json:"createdAt" query:"createdAt"`
	UpdatedAt string       `protobuf:"bytes,13,opt,name=updatedAt,proto3" form:"updatedAt" json:"updatedAt" query:"updatedAt"`
	RoleValue string       `protobuf:"bytes,14,opt,name=roleValue,proto3" form:"roleValue" json:"roleValue" query:"roleValue"`
	SideMode  string       `protobuf:"bytes,15,opt,name=sideMode,proto3" form:"sideMode" json:"sideMode" query:"sideMode"`
}
...
type UserListResp struct {
	...
	ErrCode base.ErrCode    `protobuf:"varint,1,opt,name=errCode,proto3,enum=base.ErrCode" form:"errCode" json:"errCode" query:"errCode"`
	ErrMsg  string          `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	Total   uint64          `protobuf:"varint,3,opt,name=total,proto3" form:"total" json:"total" query:"total"`
	Data    []*UserInfoResp `protobuf:"bytes,4,rep,name=data,proto3" form:"data" json:"data" query:"data"`
}
...
type UserListReq struct {
	...
	PageSize uint64 `protobuf:"varint,2,opt,name=pageSize,proto3" form:"pageSize" json:"pageSize" query:"pageSize"`
	...
	Email    string `protobuf:"bytes,5,opt,name=email,proto3" form:"email" json:"email" query:"email"`
	Mobile   string `protobuf:"bytes,6,opt,name=mobile,proto3" form:"mobile" json:"mobile" query:"mobile"`
	RoleID   uint64 `protobuf:"varint,7,opt,name=roleID,proto3" form:"roleID" json:"roleID" query:"roleID"`
}
...
type PermCodeResp struct {
	...
	ErrCode base.ErrCode `protobuf:"varint,1,opt,name=errCode,proto3,enum=base.ErrCode" form:"errCode" json:"errCode" query:"errCode"`
	ErrMsg  string       `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	Data    []string     `protobuf:"bytes,3,rep,name=data,proto3" form:"data" json:"data" query:"data"`
}
...
type ApiInfo struct {
	...
	ID          uint64 `protobuf:"varint,1,opt,name=ID,proto3" form:"ID" json:"ID" query:"ID"`
	CreatedAt   string `protobuf:"bytes,2,opt,name=createdAt,proto3" form:"createdAt" json:"createdAt" query:"createdAt"`
	UpdatedAt   string `protobuf:"bytes,3,opt,name=updatedAt,proto3" form:"updatedAt" json:"updatedAt" query:"updatedAt"`
	...
	Group       string `protobuf:"bytes,6,opt,name=group,proto3" form:"group" json:"group" query:"group"`
	Method      string `protobuf:"bytes,7,opt,name=method,proto3" form:"method" json:"method" query:"method"`
}
...
type ApiListResp struct {
	...
	ErrMsg  string       `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	Total   uint64       `protobuf:"varint,3,opt,name=total,proto3" form:"total" json:"total" query:"total"`
	Data    []*ApiInfo   `protobuf:"bytes,4,rep,name=data,proto3" form:"data" json:"data" query:"data"`
}
...
type ApiPageReq struct {
	...
	Page        uint64 `protobuf:"varint,1,opt,name=page,proto3" form:"page" json:"page" query:"page"`
	PageSize    uint64 `protobuf:"varint,2,opt,name=pageSize,proto3" form:"pageSize" json:"pageSize" query:"pageSize"`
	Path        string `protobuf:"bytes,3,opt,name=path,proto3" form:"path" json:"path" query:"path"`
	Description string `protobuf:"bytes,4,opt,name=description,proto3" form:"description" json:"description" query:"description"`
	Method      string `protobuf:"bytes,5,opt,name=method,proto3" form:"method" json:"method" query:"method"`
	Group       string `protobuf:"bytes,6,opt,name=group,proto3" form:"group" json:"group" query:"group"`
}
...
type CreateOrUpdateApiAuthorityReq struct {
	...
	RoleID uint64              `protobuf:"varint,1,opt,name=roleID,proto3" form:"roleID" json:"roleID" query:"roleID"`
	Data   []*ApiAuthorityInfo `protobuf:"bytes,2,rep,name=data,proto3" form:"data" json:"data" query:"data"`
}
...
type ApiAuthorityListInfoResp struct {
	...
	ErrMsg  string              `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	Total   uint64              `protobuf:"varint,3,opt,name=total,proto3" form:"total" json:"total" query:"total"`
	Data    []*ApiAuthorityInfo `protobuf:"bytes,4,rep,name=data,proto3" form:"data" json:"data" query:"data"`
}
...
type MenuAuthorityInfoReq struct {
	...
	RoleID  uint64   `protobuf:"varint,1,opt,name=roleID,proto3" form:"roleID" json:"roleID" query:"roleID"`
	MenuIDs []uint64 `protobuf:"varint,2,rep,packed,name=MenuIDs,proto3" form:"MenuIDs" json:"MenuIDs" query:"MenuIDs"`
}
...
type MenuAuthorityInfoResp struct {
	...
	ErrMsg  string       `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	RoleID  uint64       `protobuf:"varint,3,opt,name=roleID,proto3" form:"roleID" json:"roleID" query:"roleID"`
	MenuIDs []uint64     `protobuf:"varint,4,rep,packed,name=MenuIDs,proto3" form:"MenuIDs" json:"MenuIDs" query:"MenuIDs"`
}
...
type CreateOrUpdateMenuReq struct {
	...
	ID        uint64 `protobuf:"varint,1,opt,name=ID,proto3" form:"ID" json:"ID" query:"ID"`
	ParentID  uint64 `protobuf:"varint,2,opt,name=parentID,proto3" form:"parentID" json:"parentID" query:"parentID"`
	Level     uint32 `protobuf:"varint,3,opt,name=level,proto3" form:"level" json:"level" query:"level"`
	Path      string `protobuf:"bytes,4,opt,name=path,proto3" form:"path" json:"path" query:"path"`
	Name      string `protobuf:"bytes,5,opt,name=name,proto3" form:"name" json:"name" query:"name"`
	Redirect  string `protobuf:"bytes,6,opt,name=redirect,proto3" form:"redirect" json:"redirect" query:"redirect"`
	Component string `protobuf:"bytes,7,opt,name=component,proto3" form:"component" json:"component" query:"component"`
	OrderNo   uint32 `protobuf:"varint,8,opt,name=orderNo,proto3" form:"orderNo" json:"orderNo" query:"orderNo"`
	Disabled  bool   `protobuf:"varint,9,opt,name=disabled,proto3" form:"disabled" json:"disabled" query:"disabled"`
	MenuType  uint32 `protobuf:"varint,10,opt,name=menuType,proto3" form:"menuType" json:"menuType" query:"menuType"`
	Meta      *Meta  `protobuf:"bytes,11,opt,name=meta,proto3" form:"meta" json:"meta" query:"meta"`
}
...
type MenuInfo struct {
	...
	CreatedAt string      `protobuf:"bytes,2,opt,name=createdAt,proto3" form:"createdAt" json:"createdAt" query:"createdAt"`
	UpdatedAt string      `protobuf:"bytes,3,opt,name=updatedAt,proto3" form:"updatedAt" json:"updatedAt" query:"updatedAt"`
	Level     uint32      `protobuf:"varint,4,opt,name=level,proto3" form:"level" json:"level" query:"level"`
	ParentID  uint64      `protobuf:"varint,5,opt,name=parentID,proto3" form:"parentID" json:"parentID" query:"parentID"`
	Path      string      `protobuf:"bytes,6,opt,name=path,proto3" form:"path" json:"path" query:"path"`
	Name      string      `protobuf:"bytes,7,opt,name=name,proto3" form:"name" json:"name" query:"name"`
	Redirect  string      `protobuf:"bytes,8,opt,name=redirect,proto3" form:"redirect" json:"redirect" query:"redirect"`
	Component string      `protobuf:"bytes,9,opt,name=component,proto3" form:"component" json:"component" query:"component"`
	OrderNo   uint32      `protobuf:"varint,10,opt,name=orderNo,proto3" form:"orderNo" json:"orderNo" query:"orderNo"`
	Disabled  bool        `protobuf:"varint,11,opt,name=disabled,proto3" form:"disabled" json:"disabled" query:"disabled"`
	MenuType  uint32      `protobuf:"varint,12,opt,name=menuType,proto3" form:"menuType" json:"menuType" query:"menuType"`
	Children  []*MenuInfo `protobuf:"bytes,13,rep,name=children,proto3" form:"children" json:"children" query:"children"`
	Meta      *Meta       `protobuf:"bytes,14,opt,name=meta,proto3" form:"meta" json:"meta" query:"meta"`
}
...
type Meta struct {
	...
	Icon               string `protobuf:"bytes,2,opt,name=icon,proto3" form:"icon" json:"icon" query:"icon"`
	HideMenu           bool   `protobuf:"varint,3,opt,name=hideMenu,proto3" form:"hideMenu" json:"hideMenu" query:"hideMenu"`
	HideBreadcrumb     bool   `protobuf:"varint,4,opt,name=hideBreadcrumb,proto3" form:"hideBreadcrumb" json:"hideBreadcrumb" query:"hideBreadcrumb"`
	CurrentActiveMenu  string `protobuf:"bytes,5,opt,name=currentActiveMenu,proto3" form:"currentActiveMenu" json:"currentActiveMenu" query:"currentActiveMenu"`
	IgnoreKeepAlive    bool   `protobuf:"varint,6,opt,name=ignoreKeepAlive,proto3" form:"ignoreKeepAlive" json:"ignoreKeepAlive" query:"ignoreKeepAlive"`
	HideTab            bool   `protobuf:"varint,7,opt,name=hideTab,proto3" form:"hideTab" json:"hideTab" query:"hideTab"`
	FrameSrc           string `protobuf:"bytes,8,opt,name=frameSrc,proto3" form:"frameSrc" json:"frameSrc" query:"frameSrc"`
	CarryParam         bool   `protobuf:"varint,9,opt,name=carryParam,proto3" form:"carryParam" json:"carryParam" query:"carryParam"`
	HideChildrenInMenu bool   `protobuf:"varint,10,opt,name=hideChildrenInMenu,proto3" form:"hideChildrenInMenu" json:"hideChildrenInMenu" query:"hideChildrenInMenu"`
	Affix              bool   `protobuf:"varint,11,opt,name=affix,proto3" form:"affix" json:"affix" query:"affix"`
	DynamicLevel       uint32 `protobuf:"varint,12,opt,name=dynamicLevel,proto3" form:"dynamicLevel" json:"dynamicLevel" query:"dynamicLevel"`
	RealPath           string `protobuf:"bytes,13,opt,name=realPath,proto3" form:"realPath" json:"realPath" query:"realPath"`
}
...
type MenuInfoListResp struct {
	...
	ErrMsg  string       `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	Total   uint64       `protobuf:"varint,3,opt,name=total,proto3" form:"total" json:"total" query:"total"`
	Data    []*MenuInfo  `protobuf:"bytes,4,rep,name=data,proto3" form:"data" json:"data" query:"data"`
}
...
type MenuListBase struct {
	...
	ParentID  uint32          `protobuf:"varint,1,opt,name=parentID,proto3" form:"parentID" json:"parentID" query:"parentID"`
	Level     uint32          `protobuf:"varint,2,opt,name=level,proto3" form:"level" json:"level" query:"level"`
	Path      string          `protobuf:"bytes,3,opt,name=path,proto3" form:"path" json:"path" query:"path"`
	Name      string          `protobuf:"bytes,4,opt,name=name,proto3" form:"name" json:"name" query:"name"`
	Redirect  string          `protobuf:"bytes,5,opt,name=redirect,proto3" form:"redirect" json:"redirect" query:"redirect"`
	Component string          `protobuf:"bytes,6,opt,name=component,proto3" form:"component" json:"component" query:"component"`
	OrderNo   uint32          `protobuf:"varint,7,opt,name=orderNo,proto3" form:"orderNo" json:"orderNo" query:"orderNo"`
	Disabled  bool            `protobuf:"varint,8,opt,name=disabled,proto3" form:"disabled" json:"disabled" query:"disabled"`
	Children  []*MenuListBase `protobuf:"bytes,9,rep,name=children,proto3" form:"children" json:"children" query:"children"`
	Meta      *Meta           `protobuf:"bytes,10,opt,name=meta,proto3" form:"meta" json:"meta" query:"meta"`
}
...
type CreateOrUpdateMenuParamReq struct {
	...
	ID     uint64 `protobuf:"varint,1,opt,name=ID,proto3" form:"ID" json:"ID" query:"ID"`
	MenuID uint64 `protobuf:"varint,2,opt,name=menuID,proto3" form:"menuID" json:"menuID" query:"menuID"`
	Type   string `protobuf:"bytes,3,opt,name=type,proto3" form:"type" json:"type" query:"type"`
	Key    string `protobuf:"bytes,4,opt,name=key,proto3" form:"key" json:"key" query:"key"`
	Value  string `protobuf:"bytes,5,opt,name=value,proto3" form:"value" json:"value" query:"value"`
}
...
type MenuParamResp struct {
	...
	Key       string       `protobuf:"bytes,5,opt,name=key,proto3" form:"key" json:"key" query:"key"`
	Value     string       `protobuf:"bytes,6,opt,name=value,proto3" form:"value" json:"value" query:"value"`
	CreatedAt string       `protobuf:"bytes,7,opt,name=createdAt,proto3" form:"createdAt" json:"createdAt" query:"createdAt"`
	UpdatedAt string       `protobuf:"bytes,8,opt,name=updatedAt,proto3" form:"updatedAt" json:"updatedAt" query:"updatedAt"`
}
...
type MenuParamListResp struct {
	...
	ErrMsg  string           `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	Total   uint64           `protobuf:"varint,3,opt,name=total,proto3" form:"total" json:"total" query:"total"`
	Data    []*MenuParamResp `protobuf:"bytes,4,rep,name=data,proto3" form:"data" json:"data" query:"data"`
}
...
type RoleInfo struct {
	...
	DefaultRouter string `protobuf:"bytes,4,opt,name=defaultRouter,proto3" form:"defaultRouter" json:"defaultRouter" query:"defaultRouter"`
	Status        uint64 `protobuf:"varint,5,opt,name=status,proto3" form:"status" json:"status" query:"status"`
	Remark        string `protobuf:"bytes,6,opt,name=remark,proto3" form:"remark" json:"remark" query:"remark"`
	OrderNo       uint32 `protobuf:"varint,7,opt,name=orderNo,proto3" form:"orderNo" json:"orderNo" query:"orderNo"`
	CreatedAt     string `protobuf:"bytes,8,opt,name=createdAt,proto3" form:"createdAt" json:"createdAt" query:"createdAt"`
	UpdatedAt     string `protobuf:"bytes,9,opt,name=updatedAt,proto3" form:"updatedAt" json:"updatedAt" query:"updatedAt"`
}
...
type RoleInfoResp struct {
	...
	Name          string       `protobuf:"bytes,4,opt,name=name,proto3" form:"name" json:"name" query:"name"`
	Value         string       `protobuf:"bytes,5,opt,name=value,proto3" form:"value" json:"value" query:"value"`
	DefaultRouter string       `protobuf:"bytes,6,opt,name=defaultRouter,proto3" form:"defaultRouter" json:"defaultRouter" query:"defaultRouter"`
	Status        uint64       `protobuf:"varint,7,opt,name=status,proto3" form:"status" json:"status" query:"status"`
	Remark        string       `protobuf:"bytes,8,opt,name=remark,proto3" form:"remark" json:"remark" query:"remark"`
	OrderNo       uint32       `protobuf:"varint,9,opt,name=orderNo,proto3" form:"orderNo" json:"orderNo" query:"orderNo"`
	CreatedAt     string       `protobuf:"bytes,10,opt,name=createdAt,proto3" form:"createdAt" json:"createdAt" query:"createdAt"`
	UpdatedAt     string       `protobuf:"bytes,11,opt,name=updatedAt,proto3" form:"updatedAt" json:"updatedAt" query:"updatedAt"`
}
...
type RoleListResp struct {
	...
	ErrMsg  string       `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	Total   uint64       `protobuf:"varint,3,opt,name=total,proto3" form:"total" json:"total" query:"total"`
	Data    []*RoleInfo  `protobuf:"bytes,4,rep,name=data,proto3" form:"data" json:"data" query:"data"`
}
...
type TokenInfo struct {
	...
	CreatedAt string `protobuf:"bytes,2,opt,name=createdAt,proto3" form:"createdAt" json:"createdAt" query:"createdAt"`
	UpdatedAt string `protobuf:"bytes,3,opt,name=updatedAt,proto3" form:"updatedAt" json:"updatedAt" query:"updatedAt"`
	UserID    uint64 `protobuf:"varint,4,opt,name=userID,proto3" form:"userID" json:"userID" query:"userID"`
	UserName  string `protobuf:"bytes,5,opt,name=userName,proto3" form:"userName" json:"userName" query:"userName"`
	Token     string `protobuf:"bytes,6,opt,name=token,proto3" form:"token" json:"token" query:"token"`
	Source    string `protobuf:"bytes,7,opt,name=source,proto3" form:"source" json:"source" query:"source"`
	ExpiredAt string `protobuf:"bytes,8,opt,name=expiredAt,proto3" form:"expiredAt" json:"expiredAt" query:"expiredAt"`
}
...
type TokenListResp struct {
	...
	ErrMsg  string       `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	Total   uint64       `protobuf:"varint,3,opt,name=total,proto3" form:"total" json:"total" query:"total"`
	Data    []*TokenInfo `protobuf:"bytes,4,rep,name=data,proto3" form:"data" json:"data" query:"data"`
}
...
type DictionaryInfo struct {
	...
	Status      uint64 `protobuf:"varint,4,opt,name=status,proto3" form:"status" json:"status" query:"status"`
	Description string `protobuf:"bytes,5,opt,name=description,proto3" form:"description" json:"description" query:"description"`
	CreatedAt   string `protobuf:"bytes,6,opt,name=createdAt,proto3" form:"createdAt" json:"createdAt" query:"createdAt"`
	UpdatedAt   string `protobuf:"bytes,7,opt,name=updatedAt,proto3" form:"updatedAt" json:"updatedAt" query:"updatedAt"`
}
...
type DictionaryListResp struct {
	...
	ErrMsg  string            `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	Total   uint64            `protobuf:"varint,3,opt,name=total,proto3" form:"total" json:"total" query:"total"`
	Data    []*DictionaryInfo `protobuf:"bytes,4,rep,name=data,proto3" form:"data" json:"data" query:"data"`
}
...
type DictionaryDetail struct {
	...
	ID        uint64 `protobuf:"varint,1,opt,name=ID,proto3" form:"ID" json:"ID" query:"ID"`
	Title     string `protobuf:"bytes,2,opt,name=title,proto3" form:"title" json:"title" query:"title"`
	Key       string `protobuf:"bytes,3,opt,name=key,proto3" form:"key" json:"key" query:"key"`
	Value     string `protobuf:"bytes,4,opt,name=value,proto3" form:"value" json:"value" query:"value"`
	Status    uint64 `protobuf:"varint,5,opt,name=status,proto3" form:"status" json:"status" query:"status"`
	CreatedAt string `protobuf:"bytes,6,opt,name=createdAt,proto3" form:"createdAt" json:"createdAt" query:"createdAt"`
	UpdatedAt string `protobuf:"bytes,7,opt,name=updatedAt,proto3" form:"updatedAt" json:"updatedAt" query:"updatedAt"`
	ParentID  uint64 `protobuf:"varint,8,opt,name=parentID,proto3" form:"parentID" json:"parentID" query:"parentID"`
}
...
type DictionaryDetailListResp struct {
	...
	ErrMsg  string              `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	Total   uint64              `protobuf:"varint,3,opt,name=total,proto3" form:"total" json:"total" query:"total"`
	Data    []*DictionaryDetail `protobuf:"bytes,4,rep,name=data,proto3" form:"data" json:"data" query:"data"`
}
...
type DictionaryPageReq struct {
	...
	PageSize uint64 `protobuf:"varint,4,opt,name=pageSize,proto3" form:"pageSize" json:"pageSize" query:"pageSize"`
}
...
type LogsInfo struct {
	...
	Method      string `protobuf:"bytes,2,opt,name=method,proto3" form:"method" json:"method" query:"method"`
	Api         string `protobuf:"bytes,3,opt,name=api,proto3" form:"api" json:"api" query:"api"`
	Success     bool   `protobuf:"varint,4,opt,name=success,proto3" form:"success" json:"success" query:"success"`
	ReqContent  string `protobuf:"bytes,5,opt,name=reqContent,proto3" form:"reqContent" json:"reqContent" query:"reqContent"`
	RespContent string `protobuf:"bytes,6,opt,name=respContent,proto3" form:"respContent" json:"respContent" query:"respContent"`
	Ip          string `protobuf:"bytes,7,opt,name=ip,proto3" form:"ip" json:"ip" query:"ip"`
	UserAgent   string `protobuf:"bytes,8,opt,name=userAgent,proto3" form:"userAgent" json:"userAgent" query:"userAgent"`
	Operator    string `protobuf:"bytes,9,opt,name=operator,proto3" form:"operator" json:"operator" query:"operator"`
	Time        uint32 `protobuf:"varint,10,opt,name=time,proto3" form:"time" json:"time" query:"time"`
	CreatedAt   string `protobuf:"bytes,11,opt,name=createdAt,proto3" form:"createdAt" json:"createdAt" query:"createdAt"`
	UpdatedAt   string `protobuf:"bytes,12,opt,name=updatedAt,proto3" form:"updatedAt" json:"updatedAt" query:"updatedAt"`
}
...
type LogsListReq struct {
	...
	PageSize uint64 `protobuf:"varint,2,opt,name=pageSize,proto3" form:"pageSize" json:"pageSize" query:"pageSize"`
	Type     string `protobuf:"bytes,3,opt,name=type,proto3" form:"type" json:"type" query:"type"`
	Method   string `protobuf:"bytes,4,opt,name=method,proto3" form:"method" json:"method" query:"method"`
	Api      string `protobuf:"bytes,5,opt,name=api,proto3" form:"api" json:"api" query:"api"`
	Success  string `protobuf:"bytes,6,opt,name=success,proto3" form:"success" json:"success" query:"success"`
	Operator string `protobuf:"bytes,7,opt,name=operator,proto3" form:"operator" json:"operator" query:"operator"`
}
...
type LogsListResp struct {
	...
	ErrMsg  string       `protobuf:"bytes,2,opt,name=errMsg,proto3" form:"errMsg" json:"errMsg" query:"errMsg"`
	Total   uint64       `protobuf:"varint,3,opt,name=total,proto3" form:"total" json:"total" query:"total"`
	Data    []*LogsInfo  `protobuf:"bytes,4,rep,name=data,proto3" form:"data" json:"data" query:"data"`
}
...
var file_admin_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x22, 0xbe, 0x02, 0x0a, 0x08, 0x4c, 0x6f, 0x67, 0x73, 0x49,
	...
	,
	...
	0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xb1, 0x01, 0x0a, 0x0b, 0x4c, 0x6f, 0x67, 0x73,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x2f, 0x64, 0x69, 0x63, 0x74, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x64, 0x0a, 0x16, 0x43, 0x72,
	...
	,
...
var file_admin_proto_goTypes = []interface{}{
	...
	(*LogsInfo)(nil),                      // 48: admin.LogsInfo
	(*LogsListReq)(nil),                   // 49: admin.LogsListReq
	(*LogsListResp)(nil),                  // 50: admin.LogsListResp
	(base.ErrCode)(0),                     // 51: base.ErrCode
	(*base.Empty)(nil),                    // 52: base.Empty
	(*base.IDReq)(nil),                    // 53: base.IDReq
	(*base.StatusCodeReq)(nil),            // 54: base.StatusCodeReq
	(*base.PageInfoReq)(nil),              // 55: base.PageInfoReq
	(*base.BaseResp)(nil),                 // 56: base.BaseResp
}
var file_admin_proto_depIdxs = []int32{
	51, // 0: admin.StructResp.errCode:type_name -> base.ErrCode
	51, // 1: admin.ProtoResp.errCode:type_name -> base.ErrCode
	51, // 2: admin.CaptchaInfoResp.errCode:type_name -> base.ErrCode
	...
	51, // 5: admin.ProfileResp.errCode:type_name -> base.ErrCode
	51, // 6: admin.UserInfoResp.errCode:type_name -> base.ErrCode
	51, // 7: admin.UserListResp.errCode:type_name -> base.ErrCode
	15, // 8: admin.UserListResp.data:type_name -> admin.UserInfoResp
	51, // 9: admin.PermCodeResp.errCode:type_name -> base.ErrCode
	51, // 10: admin.ApiListResp.errCode:type_name -> base.ErrCode
	...
	51, // 13: admin.ApiAuthorityListInfoResp.errCode:type_name -> base.ErrCode
	22, // 14: admin.ApiAuthorityListInfoResp.data:type_name -> admin.ApiAuthorityInfo
	51, // 15: admin.MenuAuthorityInfoResp.errCode:type_name -> base.ErrCode
	...
	51, // 19: admin.MenuInfoListResp.errCode:type_name -> base.ErrCode
	...
	51, // 23: admin.MenuParamResp.errCode:type_name -> base.ErrCode
	51, // 24: admin.MenuParamListResp.errCode:type_name -> base.ErrCode
	33, // 25: admin.MenuParamListResp.data:type_name -> admin.MenuParamResp
	51, // 26: admin.RoleInfoResp.errCode:type_name -> base.ErrCode
	51, // 27: admin.RoleListResp.errCode:type_name -> base.ErrCode
	35, // 28: admin.RoleListResp.data:type_name -> admin.RoleInfo
	51, // 29: admin.TokenListResp.errCode:type_name -> base.ErrCode
	38, // 30: admin.TokenListResp.data:type_name -> admin.TokenInfo
	51, // 31: admin.DictionaryListResp.errCode:type_name -> base.ErrCode
	42, // 32: admin.DictionaryListResp.data:type_name -> admin.DictionaryInfo
	51, // 33: admin.DictionaryDetailListResp.errCode:type_name -> base.ErrCode
	44, // 34: admin.DictionaryDetailListResp.data:type_name -> admin.DictionaryDetail
	51, // 35: admin.LogsListResp.errCode:type_name -> base.ErrCode
	48, // 36: admin.LogsListResp.data:type_name -> admin.LogsInfo
	52, // 37: admin.admin.InitDatabase:input_type -> base.Empty
	52, // 38: admin.admin.HealthCheck:input_type -> base.Empty
	52, // 39: admin.admin.Captcha:input_type -> base.Empty
	0,  // 40: admin.admin.DeleteStructTag:input_type -> admin.StructReq
	0,  // 41: admin.admin.StructToProto:input_type -> admin.StructReq
	12, // 42: admin.user.Register:input_type -> admin.RegisterReq
	52, // 43: admin.user.UserPermCode:input_type -> base.Empty
	13, // 44: admin.user.ChangePassword:input_type -> admin.ChangePasswordReq
	14, // 45: admin.user.CreateUser:input_type -> admin.CreateOrUpdateUserReq
	14, // 46: admin.user.UpdateUser:input_type -> admin.CreateOrUpdateUserReq
	52, // 47: admin.user.UserInfo:input_type -> base.Empty
	17, // 48: admin.user.UserList:input_type -> admin.UserListReq
	53, // 49: admin.user.DeleteUser:input_type -> base.IDReq
	11, // 50: admin.user.UpdateProfile:input_type -> admin.ProfileReq
	52, // 51: admin.user.UserProfile:input_type -> base.Empty
	54, // 52: admin.user.UpdateUserStatus:input_type -> base.StatusCodeReq
	19, // 53: admin.apis.CreateApi:input_type -> admin.ApiInfo
	19, // 54: admin.apis.UpdateApi:input_type -> admin.ApiInfo
	53, // 55: admin.apis.DeleteApi:input_type -> base.IDReq
	21, // 56: admin.apis.ApiList:input_type -> admin.ApiPageReq
	23, // 57: admin.authority.CreateAuthority:input_type -> admin.CreateOrUpdateApiAuthorityReq
	23, // 58: admin.authority.UpdateApiAuthority:input_type -> admin.CreateOrUpdateApiAuthorityReq
	53, // 59: admin.authority.ApiAuthority:input_type -> base.IDReq
	25, // 60: admin.authority.CreateMenuAuthority:input_type -> admin.MenuAuthorityInfoReq
	25, // 61: admin.authority.UpdateMenuAuthority:input_type -> admin.MenuAuthorityInfoReq
	53, // 62: admin.authority.MenuAuthority:input_type -> base.IDReq
	27, // 63: admin.menu.CreateMenu:input_type -> admin.CreateOrUpdateMenuReq
	27, // 64: admin.menu.UpdateMenu:input_type -> admin.CreateOrUpdateMenuReq
	53, // 65: admin.menu.DeleteMenu:input_type -> base.IDReq
	52, // 66: admin.menu.MenuByRole:input_type -> base.Empty
	55, // 67: admin.menu.MenuList:input_type -> base.PageInfoReq
	32, // 68: admin.menu.CreateMenuParam:input_type -> admin.CreateOrUpdateMenuParamReq
	32, // 69: admin.menu.UpdateMenuParam:input_type -> admin.CreateOrUpdateMenuParamReq
	53, // 70: admin.menu.DeleteMenuParam:input_type -> base.IDReq
	53, // 71: admin.menu.MenuParamListByMenuID:input_type -> base.IDReq
	35, // 72: admin.role.CreateRole:input_type -> admin.RoleInfo
	35, // 73: admin.role.UpdateRole:input_type -> admin.RoleInfo
	53, // 74: admin.role.DeleteRole:input_type -> base.IDReq
	53, // 75: admin.role.RoleByID:input_type -> base.IDReq
	55, // 76: admin.role.RoleList:input_type -> base.PageInfoReq
	54, // 77: admin.role.UpdateRoleStatus:input_type -> base.StatusCodeReq
	38, // 78: admin.token.UpdateToken:input_type -> admin.TokenInfo
	41, // 79: admin.token.DeleteToken:input_type -> admin.DeleteReq
	40, // 80: admin.token.TokenList:input_type -> admin.TokenListReq
	42, // 81: admin.dictionary.CreateDictionary:input_type -> admin.DictionaryInfo
	42, // 82: admin.dictionary.UpdateDictionary:input_type -> admin.DictionaryInfo
	53, // 83: admin.dictionary.DeleteDictionary:input_type -> base.IDReq
	47, // 84: admin.dictionary.DictionaryList:input_type -> admin.DictionaryPageReq
	44, // 85: admin.dictionary.CreateDictionaryDetail:input_type -> admin.DictionaryDetail
	44, // 86: admin.dictionary.UpdateDictionaryDetail:input_type -> admin.DictionaryDetail
	53, // 87: admin.dictionary.DeleteDictionaryDetail:input_type -> base.IDReq
	46, // 88: admin.dictionary.DetailByDictionaryName:input_type -> admin.DictionaryDetailReq
	49, // 89: admin.logs.GetLogsList:input_type -> admin.LogsListReq
	52, // 90: admin.logs.DeleteLogs:input_type -> base.Empty
	56, // 91: admin.admin.InitDatabase:output_type -> base.BaseResp
	56, // 92: admin.admin.HealthCheck:output_type -> base.BaseResp
	3,  // 93: admin.admin.Captcha:output_type -> admin.CaptchaInfoResp
	1,  // 94: admin.admin.DeleteStructTag:output_type -> admin.StructResp
	2,  // 95: admin.admin.StructToProto:output_type -> admin.ProtoResp
	56, // 96: admin.user.Register:output_type -> base.BaseResp
	18, // 97: admin.user.UserPermCode:output_type -> admin.PermCodeResp
	56, // 98: admin.user.ChangePassword:output_type -> base.BaseResp
	56, // 99: admin.user.CreateUser:output_type -> base.BaseResp
	56, // 100: admin.user.UpdateUser:output_type -> base.BaseResp
	15, // 101: admin.user.UserInfo:output_type -> admin.UserInfoResp
	16, // 102: admin.user.UserList:output_type -> admin.UserListResp
	56, // 103: admin.user.DeleteUser:output_type -> base.BaseResp
	56, // 104: admin.user.UpdateProfile:output_type -> base.BaseResp
	10, // 105: admin.user.UserProfile:output_type -> admin.ProfileResp
	56, // 106: admin.user.UpdateUserStatus:output_type -> base.BaseResp
	56, // 107: admin.apis.CreateApi:output_type -> base.BaseResp
	56, // 108: admin.apis.UpdateApi:output_type -> base.BaseResp
	56, // 109: admin.apis.DeleteApi:output_type -> base.BaseResp
	20, // 110: admin.apis.ApiList:output_type -> admin.ApiListResp
	56, // 111: admin.authority.CreateAuthority:output_type -> base.BaseResp
	56, // 112: admin.authority.UpdateApiAuthority:output_type -> base.BaseResp
	24, // 113: admin.authority.ApiAuthority:output_type -> admin.ApiAuthorityListInfoResp
	56, // 114: admin.authority.CreateMenuAuthority:output_type -> base.BaseResp
	56, // 115: admin.authority.UpdateMenuAuthority:output_type -> base.BaseResp
	26, // 116: admin.authority.MenuAuthority:output_type -> admin.MenuAuthorityInfoResp
	56, // 117: admin.menu.CreateMenu:output_type -> base.BaseResp
	56, // 118: admin.menu.UpdateMenu:output_type -> base.BaseResp
	56, // 119: admin.menu.DeleteMenu:output_type -> base.BaseResp
	30, // 120: admin.menu.MenuByRole:output_type -> admin.MenuInfoListResp
	30, // 121: admin.menu.MenuList:output_type -> admin.MenuInfoListResp
	56, // 122: admin.menu.CreateMenuParam:output_type -> base.BaseResp
	56, // 123: admin.menu.UpdateMenuParam:output_type -> base.BaseResp
	56, // 124: admin.menu.DeleteMenuParam:output_type -> base.BaseResp
	34, // 125: admin.menu.MenuParamListByMenuID:output_type -> admin.MenuParamListResp
	56, // 126: admin.role.CreateRole:output_type -> base.BaseResp
	56, // 127: admin.role.UpdateRole:output_type -> base.BaseResp
	56, // 128: admin.role.DeleteRole:output_type -> base.BaseResp
	36, // 129: admin.role.RoleByID:output_type -> admin.RoleInfoResp
	37, // 130: admin.role.RoleList:output_type -> admin.RoleListResp
	56, // 131: admin.role.UpdateRoleStatus:output_type -> base.BaseResp
	56, // 132: admin.token.UpdateToken:output_type -> base.BaseResp
	56, // 133: admin.token.DeleteToken:output_type -> base.BaseResp
	39, // 134: admin.token.TokenList:output_type -> admin.TokenListResp
	56, // 135: admin.dictionary.CreateDictionary:output_type -> base.BaseResp
	56, // 136: admin.dictionary.UpdateDictionary:output_type -> base.BaseResp
	56, // 137: admin.dictionary.DeleteDictionary:output_type -> base.BaseResp
	43, // 138: admin.dictionary.DictionaryList:output_type -> admin.DictionaryListResp
	56, // 139: admin.dictionary.CreateDictionaryDetail:output_type -> base.BaseResp
	56, // 140: admin.dictionary.UpdateDictionaryDetail:output_type -> base.BaseResp
	56, // 141: admin.dictionary.DeleteDictionaryDetail:output_type -> base.BaseResp
	45, // 142: admin.dictionary.DetailByDictionaryName:output_type -> admin.DictionaryDetailListResp
	50, // 143: admin.logs.GetLogsList:output_type -> admin.LogsListResp
	56, // 144: admin.logs.DeleteLogs:output_type -> base.BaseResp
