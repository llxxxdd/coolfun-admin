...
type BaseResp struct {
	...
	ErrCode ErrCode `protobuf:"varint,1,opt,name=errCode,proto3,enum=base.ErrCode" form:"errCode" json:"errCode" query:"errCode"`
...
type StatusCodeReq struct {
	...
	ID     uint64 `protobuf:"varint,1,opt,name=ID,proto3" form:"ID" json:"ID" query:"ID"`
	Status uint64 `protobuf:"varint,2,opt,name=status,proto3" form:"status" json:"status" query:"status"`
}
...
var file_base_proto_rawDesc = []byte{
	...
	0x00, 0x12, 0x08, 0x0a, 0x04, 0x46, 0x61, 0x69, 0x6c, 0x10, 0x01, 0x42, 0x1e, 0x5a, 0x1c, 0x63,
	0x6f, 0x6f, 0x6c, 0x66, 0x75, 0x6e, 0x2d, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2f, 0x61, 0x70, 0x69,
